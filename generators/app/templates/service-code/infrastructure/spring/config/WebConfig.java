...
import com.bme.clp.bck.<%=resourceDot%>.q.domain.service.impl.DomainServiceImpl;
...
import com.bme.clp.bck.<%=resourceDot%>.q.usecase.service.impl.UseCaseServiceImpl;
...
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.impl.AdvancedQueryApiDelegateImpl;
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.impl.QueryApiDelegateImpl;
import com.bme.clp.bck.<%=resourceDot%>.q.web.mapper.JsonApiMapper;

@Configuration
@ComponentScan(basePackages = { "org.openapitools",
  "org.openapitools.configuration",
  "com.bme.clp.bck.<%=resourceDot%>.q.usecase.service.impl",
  "com.bme.clp.bck.<%=resourceDot%>.q.infrastructure",
  "com.bme.clp.bck.<%=resourceDot%>.q.web.mapper",
  "com.bme.clp.bck.<%=resourceDot%>.q.web.api",
  "com.bme.clp.bck.<%=resourceDot%>.q.infrastructure.spring" }
)
