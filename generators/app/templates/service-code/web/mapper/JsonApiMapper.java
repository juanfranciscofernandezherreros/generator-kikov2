package com.bme.clp.bck.<%=resourceDot%>.q.web.mapper;
...
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.model.AttributesIdType;
...
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.model.LinksPaginationType;
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.model.MetaType;
import com.bme.clp.bck.<%=resourceDot%>.q.web.api.model.ResourceType;
